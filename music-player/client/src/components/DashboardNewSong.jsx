...
const DashboardNewSong = () => {
  ...
  const [{ artists, allAlbums , artistFilter,filterTerm,albumFilter,languageFilter}, dispatch] = useStateValue();
...
//throw an alert there is audio image or song image cover is missing
} else{
setIsAudioLoading(true);
setIsImageLoading(true);
